...
//		LogPrint("gin_protobass: init");
	...
	{
		dui->DrawTexturedBar(0, 0, 400, 50, dui->palette[7], dui->brushed_metal, &dui->vglare);
		...
		dui->DrawText(335-1, 40, dui->palette[4], "protobass");
		dui->DrawText(335+1, 40, dui->palette[4], "protobass");
		dui->DrawText(335, 40, dui->palette[6], "protobass");
		dui->DoKnob(30, 30-8, params.filter_cutoff, -1, "knob_cutoff", "cutoff frequency for lowpass filter");
		dui->DrawText(30-8, 12, dui->palette[6], "cutoff");
